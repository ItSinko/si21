...
$("#check").submit(function(e) {
	...
	if(nolkpp== "" || tarif== "" || efaktur== "" || kas== "" || ket== "" || ket_log== ""  ) {
		...
		$.ajax({
			...
			data: "nolkpp="+nolkpp+"&noref="+noref+"&efaktur="+efaktur+"&tarif="+tarif+"&term="+term+"&kas="+kas+"&ket="+ket+"&idprod_on="+idprod_on+"&pabrik_on="+pabrik_on+"&diskonuji="+diskonuji+"&nosjgdg="+nosjgdg+"&ket_log="+ket_log+"&username="+username,
