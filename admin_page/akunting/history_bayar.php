...
if( isset( $_REQUEST['aksiseri'] )){
	...
	<hr class="my-2">
 	 <a class="btn btn-primary"  id="tambah" href="index.php?hlm=accon&aksi=history&nolkppacc_on='.$nolkppacc_on.'&aksiseri=tambah">Tambah Pelunasan</a> 
</head>
<body> 
    <div class="container">
	<br>
...
echo '		<tr>
			...
			<td>'.$row['ket_hs'].'</td>
			<td><a href="?hlm=accon&aksi=history&nolkppacc_on='.$nolkppacc_on.'&aksiseri=edit&idlunas_on='.$row["idlunas_on"].'" class="cus-application_form_edit"></a></td>		
			'; 
										  } 
echo '
			</tr>
