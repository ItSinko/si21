...
$("#check").submit(function(e) {
	...
	if(idorder== "" || ket_log== "") {
		...
		$.ajax({
			...
			data: "idorder="+idorder+"&noref_off="+noref_off+"&noefak_off="+noefak_off+"&tarifdiskon="+tarifdiskon+"&realisasiacc="+realisasiacc+"&term="+term+"&kas="+kas+"&ket="+ket+"&idprodacc_off="+idprodacc_off+"&pabrikacc_off="+pabrikacc_off+"&diskonujiacc_off="+diskonujiacc_off+"&nosjgdg="+nosjgdg+"&ket_log="+ket_log+"&username="+username,
