...
if( isset( $_REQUEST['aksiseri'] )){
	...
	<hr class="my-2">
 	 <a class="btn btn-primary"  id="tambah" href="index.php?hlm=accoff&aksi=history&idorderacc_off='.$idorderacc_off.'&aksiseri=tambah">Tambah Pelunasan</a> 
</head>
<body> 
    <div class="container">
	<br>
...
echo '		<tr>
			...
			<td>'.$row['ket_hs'].'</td>
			<td><a href="?hlm=accoff&aksi=history&idorderacc_off='.$idorderacc_off.'&aksiseri=edit&idlunas_off='.$row["idlunas_off"].'" class="cus-application_form_edit"></a></td>		
			'; 
										  } 
echo '
			</tr>
