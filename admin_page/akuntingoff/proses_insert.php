...
if(isset($_REQUEST['submit'])) {
	...
	//pengurangan stok untuk efaktur
	$stok = $_REQUEST["stok"];

	//pembuatan efaktur
	$potong = substr ($nosj_off,4);
	$nofakju_off = $potong.'/'.$noefak_off;

	
    //efaktur	
	$ambilefak= "UPDATE efaktur
          SET stok='$stok' WHERE noefak = '$noefak_off'";
	...
	$querya = 
			"INSERT INTO acc_off VALUES ('$idorderacc_off','$noref_off',
			'$noefak_off','$nofakju_off','$diskonacc_off'
			,'$realacc','$temphariacc_off','$tglreal','$kas_off','$ketacc_off','$pabrikacc_off','$idprodacc_off','$diskonuji')";

			
			
//pengecekan nomer efaktur
$cek = mysqli_num_rows(mysqli_query($con,"SELECT * FROM acc_off WHERE idorderacc_off='$idorderacc_off' or noefak_off='$noefak_off' "));	
