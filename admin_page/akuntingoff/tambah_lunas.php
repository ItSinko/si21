...
<tr>
     ...
     <div class="col-sm-2">
     <input class="form-control" rows="2" placeholder="ID Order" id="idorder" value="<?= $idorderacc_off; ?>" readonly >
     </div>
     </div>
...
$("#check").submit(function(e) {
	...
	if(nilai == "" || tgllunas == "" || idorder == "" ) {
		...
		$.ajax({
			type: "POST",
			url: "check_form/tambah/history_lunas_off.php",
			data: "idorder="+idorder+"&nilai="+nilai+"&tgllunas="+tgllunas+"&ket="+ket,
