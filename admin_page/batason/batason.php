...
<body>
    ...
    ?>
        <div id="demo" class="horizon" style="margin: 20px 0 50px 0">
            <p class="h5">Laporan Batas Kontrak</p>
            <hr class="my-2">
            ...
            <div class="horizon_disable">
                <table class="demo-tbl">
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        if (empty($row['tglsj_on'])) {
                            echo '<td><i class="cus-cancel" title="Nomer Seri Belum Terisi"></i><br>Belum Dikirim</td>';
                        } else if (($row['tgl_kontrak']) < ($row['tglsj_on'])) {
                            echo '<td><i class="cus-error" title="Nomer Seri Sudah Terisi"></i><br>Melebihi Batas Kontrak</td>';
                        } else {
                            echo '<td><i class="cus-accept" title="Nomer Seri Sudah Terisi"></i><br>Pengiriman Tepat Waktu</td>';
                        }
                        echo '			
