...
if( isset( $_REQUEST['aksi'] )){
		...
		switch($aksi){
			...
			case 'edit':
				include 'daftarprd/edit.php';
				break;
			case 'hapus':
				include 'daftarprd/hapus.php';
				break;
                                ...
                                <tr data-control-type="sort-buttons-group"
									...
									<th width="6%">
                                        ...
                                        <span class="sort-btns">
                                            <i class="fa fa-caret-up" data-path=".idprd" data-type="text" data-order="asc" title="Sort by Title Asc"></i>
                                            <i class="fa fa-caret-down" data-path=".idprd" data-type="text" data-order="desc" title="Sort by Title Desc"></i>
                                        </span>
										</th>
										<th width="5%">
                                        ...
                                        <span class="sort-btns">
                                            <i class="fa fa-caret-up" data-path=".kategori" data-type="text" data-order="asc" title="Sort by Title Asc"></i>
                                            <i class="fa fa-caret-down" data-path=".kategori" data-type="text" data-order="desc" title="Sort by Title Desc"></i>
                                        </span>
										
										</th>
									
										<th width="10%">Catatan</th>
										<th width="2%">Pilihan</th>
                                </tr>
                            </thead>
		 ...
		 while($row = mysqli_fetch_array($result)){
                            ...
                            <tbody>                      
                                <tr class=tbl-item>
									...
									<td class=satuan >'.$row['satuan_prod'].'</td>									
                                    <td class=kategori>'.$row['kategori'].'</td>	
									<td>'.$row['ket'].'</td>';	

?>   									
								    <td><a href="?hlm=dafprd&aksi=edit&id_prod=<?=$row["id_prod"]; ?>" class="cus-application_form_edit"></a> |
              ...
              <div class="modal-dialog">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form role="form" action="daftarprd\hapus.php" method="get">
                      ...
                      <div class="form-group">
					   ...
					   <textarea class="form-control" id="message-text" placeholder="Wajib mengisi keterangan  " name="ket_log" minlength="6" required></textarea>
						</div>
