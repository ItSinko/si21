...
$mysqli= "UPDATE produk_master
          SET merk= '$merk', sing_prod='$sing_prod', nam_prod='$nam_prod',ket='$ket',
		  kategori='$kategori'		  
...
echo '<div id="tampil_modal">
	...
	<script>
	   ...
	   document.location.href= 'daftarprd.php';
	 </script>
	 ";
...
<button class="tips3" type="pesan2" onclick="location.href='daftarprd.php'" ><span class="tooltips3" > ke halaman produk</span>Home</button>
<script>
function goBack() {
    window.history.back();
}
