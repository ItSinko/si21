...
if( isset( $_REQUEST['coo'] )){
	...
	if (mysqli_num_rows($result) > 0) {
		...
		?>
			...
			<td>
			<a href="dataprint.php?nocoo_off=<?= $row["nocoo_off"]; ?>"  
				onclick="window.open('?hlm=detoff&aksi=more&idordercoo_off=<?= $row["idordercoo_off"]; ?>&coo=edit&nocoo_off=<?= $row["nocoo_off"]; ?>  ', 
				'newwindow', 
				'width=300,height=250'); 
				return false;"  title="Hapus Data Ini"  class="cus-application_form_edit"></a>
			</td>
		<?php 
		}
		?>
