...
<?php $bulan = $array_bulan[date(''.$detail["bulan_off"].'')]; 	?>
<label  class="ref"><?php echo $detail['nocoo_off']; ?> / SKA / &nbsp; <?php echo $bulan ?>  &nbsp; / SPA / <?php echo (substr($detail['tglsj_off'],0,4)); ?></label>
</div>
...
<input type="hidden" id="tgl" name="nocoofk" value="<?php echo $detail['nocoo_off']; ?>" readonly>
</form>
<?php
$con=mysqli_connect("localhost","root","","kontrol_db");
...
$parameter_coo = $_REQUEST["nocoo_off"];


$mysqli = "INSERT INTO tglprintcoo_off VALUES ('','$tglmaster','$parameter_coo')";
...
<label class="noseri"><?php echo $detail['noseri_off']; ?></label>
...
<label class="tgl">Surabaya, <?php echo tanggal_indo ($detail["tglsj_off"]); ?></label>
...
<p class="a"><?php echo $detail['pemesan_off']; ?></p>
</div>



<div id="kotakid" class="kotakid">
<p class="b"><?php echo $detail['idordercoo_off']; ?></p>
</div>
