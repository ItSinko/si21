...
$mysqli = "UPDATE diskon_master set hargabrg='$hrgbrg',diskonnota='$diskonnota',diskonuji='$diskonuji',
temphari='$temphari',pabrikfk='$pabrikfk',idprodfk='$idprodfk' WHERE idrate2='$idrate2'";
...
<button class="tips2" type="pesan" onclick="goBack()" title="Kembali Ke Form Tambah">Input Lagi ?</button>
<button class="tips3" type="pesan2" onclick="location.href='rate2.php'" title="Kembali Ke Halaman Utama">Home</button>
