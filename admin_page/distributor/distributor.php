	...
	<hr class="my-2">
			...
			<div class="text-filter-box">
                        ...
                        <div class="text-filter-box">
						 ...
						 <button class="btn btn-primary"   onclick="location.href='./index.php?hlm=dsb&aksi=tambah'">Tambah Data</button>
		 ...
		 while($row = mysqli_fetch_array($result)){
                            ...
                            <tbody>                      
                                <tr class=tbl-item>
									...
									<td>'.$row['ket_dsb'].'</td>';	
									?>
								    <td><a href="?hlm=dsb&aksi=edit&iddsb=<?=$row["iddsb"]; ?>" class="cus-application_form_edit"></a>	
									<a href="#" type="button" class="cus-cross" data-toggle="modal" data-target="#myModal<?php echo $row["iddsb"]; ?>"></a>
									</td>																	
								</tr>
