...
<legend class="legend_form">Info Distributor</legend>
  ...
  <div class="form-group row">
	...
	<textarea class="form-control" rows="1" placeholder="Nama Distributor" id="distributor" ><?php echo $distributor["pabrik"]; ?></textarea>
     ...
     <div class="col-sm-5">
     <textarea class="form-control" rows="1" placeholder="distributor@email.com" id="alamat_email" type="email"><?php echo $distributor["alamat_email"]; ?></textarea>
     </div>
     </div>
...
$("#check").submit(function(e) {
	...
	if(iddsb == "" || distributor == "" || diskonnota == "" || diskonuji == ""|| temp == "" || ket_log == "") {
		...
		$.ajax({
			...
			data: "iddsb="+iddsb+"&distributor="+distributor+"&alamat="+alamat+"&telepon="+telepon+"&ket="+ket+"&diskonnota="+diskonnota+"&diskonuji="+diskonuji+"&temp="+temp+"&ket_log="+ket_log+"&alamat_email="+alamat_email+"&username="+username,
