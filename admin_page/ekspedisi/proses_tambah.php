...
if ($cek > 0) {
	...
	echo "<script>window.alert(' NOMER LKPP Sudah Pernah Dimasukan ! Coba nomer lain')
	...
	{
$mysqli = "INSERT INTO ekspedisi_on VALUES ('$nolkpp','$ket','$pabrik_on','$idprod_on')";
