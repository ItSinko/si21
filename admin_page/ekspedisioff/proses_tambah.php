...
//cek eror
$cek = mysqli_num_rows(mysqli_query($con,"SELECT * FROM ekspedisi_off WHERE idordereks_off='$idordereks_off'"));
if ($cek > 0) {
...
$mysqli = "INSERT INTO ekspedisi_off VALUES ('$idordereks_off','$ket','$pabrik_on','$idprod_on')";
