...
$tglsjgdg = $_REQUEST["tglsjgdg"];
$statusgdg = $_REQUEST["statusgdg"];
$noefakgdg = $_REQUEST["noefakgdg"];


		
$mysqli = "INSERT INTO tbl_gdg
          VALUES
		  ('','$nolkppgdg','$nosjgdg','$tglsjgdg','$statusgdg','$noefakgdg')";
		  

$result	= mysqli_query($W, $mysqli);
