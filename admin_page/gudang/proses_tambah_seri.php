...
$noseri_on = $_REQUEST["noseri_on"];

//cek
$cek = mysqli_num_rows(mysqli_query($con,"SELECT * from seri_on WHERE noseri_on ='$noseri_on' "));
if ($cek >0 ) {
...
$mysqli= "INSERT INTO seri_on
          VALUES
		  ('','$noseri_on','$nolkppgdg_on')";
