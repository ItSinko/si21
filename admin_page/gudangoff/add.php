...
<legend class="legend_form">Data Barang</legend>
	...
	<div class="col-sm-3">
	<input type="text" class="form-control harga"  id="nosj_off" placeholder="Masukkan No. SJ">
	</div>
	</div>
	...
	<div class="col-sm-4">
	<input type="date" id="tglsj_off" class="form-control total">
	</div>
	</div>
	...
	<div class="col-sm-8">
	<textarea rows="2" class="form-control" placeholder="Keterangan" id="ketgdg_off" style="width:300px;"></textarea>
	</div>
	</div>
...
$("#check").submit(function(e) {
	...
	if(idorder == "" || nosj_off == "") {
		...
		$.ajax({
			type: "POST",
			url: "check_form/tambah/gudangoff.php",
			data: "idorder="+idorder+"&nosj_off="+nosj_off+"&tglsj_off="+tglsj_off+"&ketgdg_off="+ketgdg_off+"&pabrikgdg_off="+pabrikgdg_off+"&idprodgdg_off="+idprodgdg_off,
