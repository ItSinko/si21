	...
	<hr class="my-2">
					...
					<div class="jplist-panel box panel-top">						
                        ...
                        <div 
						   ...
						   <button class="btn btn-primary"   onclick="location.href='./index.php?hlm=gudangoff&aksi=baru'">Tambah Data</button>
					</div>		
 <!-- data --> 
		 ...
		 while($row = mysqli_fetch_array($result)){
                            ...
                            <tbody>                      
                                <tr class=tbl-item>
								  ...
								  ?>   	
								    <td><a href="?hlm=gudangoff&aksi=edit&idordergdg_off=<?=$row["idordergdg_off"]; ?>" class="cus-application_form_edit"></a> |
									<a href="#" type="button" class="cus-cross" data-toggle="modal" data-target="#myModal<?=$row["idordergdg_off"]; ?>"></a>
									</td>			
								</tr>
