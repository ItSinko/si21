...
$noseri_off = $_REQUEST["noseri_off"];

//cek
$cek = mysqli_num_rows(mysqli_query($con,"SELECT * from seri_off WHERE noseri_off ='$noseri_off' "));
if ($cek >0 ) {
...
$mysqli= "INSERT INTO seri_off
          VALUES
		  ('','$noseri_off','$idordergdg_off')";
...
<button class="tips3" type="pesan2" onclick="goPrevious()" ><span class="tooltips3" > ke halaman produk</span>Home</button>
