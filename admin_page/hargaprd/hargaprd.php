...
if( isset( $_REQUEST['aksi'] )){
		...
		switch($aksi){
			...
			case 'edit':
				include 'hargaprd/edit.php';
				break;
			case 'hapus':
				include 'hargaprd/hapus.php';
				break;
		}
...
?>
	...
	<p class="h5">Daftar Harga Produk</p>
	<hr class="my-2">
                            ...
                            <thead class="jplist-panel">
                                <tr data-control-type="sort-buttons-group"
									...
									<th width="7%">
										...
										<th width="8%">Harga Produk (Rp)</th>
										<th width="8%">Dasar Pengenaan Pajak (DPP)</th>
		 ...
		 while($row = mysqli_fetch_array($result)){
                            ...
                            <tbody>                      
                                <tr class=tbl-item>
                                    ...
                                    <td>'. number_format($row["hargadpp"]).'</td>	
									<td class=kategori>'.$row['kategori'].'</td>	
									<td>'.$row['ket'].'</td>';	


?>   									
								    <td><a href="?hlm=harprd&aksi=edit&id_prod=<?=$row["id_prod"]; ?>" class="cus-application_form_edit"></a> |
										<a href="#" type="button" class="cus-cross" data-toggle="modal" data-target="#myModal<?php echo $row["id_prod"]; ?>"></a></td>																	
								</tr>
              ...
              <div class="modal-dialog">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form role="form" action="hargaprd\hapus.php" method="get">
