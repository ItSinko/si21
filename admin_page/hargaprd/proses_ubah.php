...
$merk = $_REQUEST["merk"];
$sing_prod = $_REQUEST["sing_prod"];
$nam_prod = $_REQUEST["nam_prod"];
...
//proses harga
$hargadpp = $_REQUEST["hargadpp"];
	$potonghargadpp = substr ($hargadpp,3);
	$hrgdpp = str_replace('.', '', $potonghargadpp);


$noakd = $_REQUEST["noakd"];
$namacoo = $_REQUEST["namacoo"];
$ket = $_REQUEST["ket"];
$jatuhakd = $_REQUEST["jatuhakd"];
$kategori = $_REQUEST["kategori"];
$kode_prod = $_REQUEST["kode_prod"];
$id_prod = $_REQUEST["id_prod"];



$mysqli= "UPDATE produk_master
          SET harga='$hrg',hargadpp='$hrgdpp',ket='$ket'
...
echo '<div id="tampil_modal">
	...
	<script>
	   ...
	   document.location.href= 'hargaprd.php';
	 </script>
	 ";
...
<button class="tips3" type="pesan2" onclick="location.href='hargaprd.php'" ><span class="tooltips3" > ke halaman produk</span>Home</button>
<script>
function goBack() {
    window.history.back();
}
