			...
			<div class="carousel-inner">
				<div class="carousel-item active ">
					<div class="jumbotron" style="background-image: url(Gray.jpg);">
						...
						<small class="pull-left" align="center"> IT Team © 2021 | PT Sinko Prima Alloy </small>
					</div>
					<img class="d-block w-50" src="bg_image\Poster_1.png" alt="Second slide" style="position: relative; left: 20%;">
				</div>
