...
?>
	...
	<hr class="my-2">
					...
					<div class="jplist-panel box panel-top">						
						...
						<button class="btn btn-primary"   onclick="location.href='./index.php?hlm=jasaeks&aksi=baru'">Tambah Data</button>
...
?>   									
								    ...
								    <td><a href="?hlm=jasaeks&aksi=edit&id_eks=<?=$row["id_eks"]; ?>" class="cus-application_form_edit"></a>
									</td>																	
								</tr>
	<?php  
								}	
