  ...
  <table id='userTable' class="table">
            ...
            if (mysqli_num_rows($result) > 0) {
				...
				?>
					...
					<td><a href="dataprint.php?nocoo_on=<?= $row["nocoo_on"]; ?>" onclick="window.open('?hlm=deton&aksi=more&nolkpp_on=<?= $row["nolkpp_on"]; ?>&coo=edit&nocoo_on=<?= $row["nocoo_on"]; ?>  ', 'newwindow', 
