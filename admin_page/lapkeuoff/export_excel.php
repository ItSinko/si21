...
<br>
	<div class="horizon">
	<h3>Laporan Keuangan (SPA Offline) - PT. SINKO PRIMA ALLOY</h3>
      <table class="tes" id="tabelExport" border="1">
        <thead>
									
  <tr>
		 
          <th colspan="27" style="width:  15.33%;   font-size:20px;"  class="align-middle" >Akunting (Keuangan)</th>
