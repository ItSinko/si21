...
if( isset( $_REQUEST['aksi'] )){
		...
		switch($aksi){
			case 'ekspor':
				include 'lapkirim_off/export_excel.php';
				break;
		}
	} else {
?>
...
<p class="h5">Laporan Pengiriman(Offline)</p>
<hr class="my-2">
...
<div class="jplist-panel box panel-top">
		...
		<button class="btn btn-primary"   onclick="location.href='lapkirimoff/export_excel.php'">Export Data</button>			
		</div>	
 ...
 <!-- data -->
  ...
  <tr>
          ...
          <th colspan="10" style="width:  15.33%;   font-size:20px;"  class="align-middle" >Informasi Pesanan</th>
