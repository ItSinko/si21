...
<?php
 ...
 header("content-disposition: attachment;filename=Laporan_Order_(Offline).xls");
...
<br>
	<div class="horizon">
      <table class="tes" id="tabelExport" border="1px">
        <thead>
         <tr>
...
$a= 1;
$result=mysqli_query($con,"SELECT * FROM spa_off INNER JOIN  admjual_off ON spa_off.idorder_off=admjual_off.idorderadm_off
