...
<body>
 ...
 <button class="btn btn-danger" id="action"  target=""  onclick="location.href='../index.php'"  title="Kembali Ke Halaman Utama Index !">Home</button>

<button class="btn btn-primary" id="action" style="position: absolute; left:5.5%;"  title="Melakukan Pengelompokan Data !">Grup Cell</button>

 <a target="_blank" href="export_excel.php" class="btn btn-success" style="position: absolute; left:12.5%;" title="Eksport Daa ke Excel" > Export Data</a>
