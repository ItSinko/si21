...
if( isset( $_REQUEST['aksi'] )){
		...
		switch($aksi){
			case 'edit':
				include 'namacoo/edit.php';
				break;
			case 'hapus':
				include 'namacoo/hapus.php';
				break;
		}
	} else {
                            ...
                            <thead class="jplist-panel">
                                <tr data-control-type="sort-buttons-group"
									...
									<th width="7%">
										...
										<th width="12%">
                                        <span class="header">Nama COO</span>
                                        <span class="sort-btns">
                                            <i class="fa fa-caret-up" data-path=".namacoo" data-type="text" data-order="asc" title="Sort by Title Asc"></i>
                                            <i class="fa fa-caret-down" data-path=".namacoo" data-type="text" data-order="desc" title="Sort by Title Desc"></i>
                                        </span>
										</th>	
                            ...
                            <tbody>                      
                                <tr class=tbl-item>
                                    ...
                                    <td class=kategori>'.$row['kategori'].'</td>
									 <td class=namacoo>'.$row['namacoo'].'</td>
									<td>'.$row['ket'].'</td>';	


?>   									

								    <td><a href="?hlm=namcoo&aksi=edit&id_prod=<?=$row["id_prod"]; ?>" class="cus-application_form_edit"></a> |
              ...
              <div class="modal-dialog">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form role="form" action="namacoo\hapus.php" method="get">
