...
<legend class="legend_form">Nomer Seri</legend>
  ...
  <div class="form-group row">
    ...
    <input class="form-control " type="text" placeholder="99" id="idorderfk"   name="idorderoff"   value= "<?= $noseri["idorderfk_off"]; ?>"  readonly> 
	</div>
	</div>
	</div> 
...
<a href="./index.php?hlm=noserioff&aksi=more&idorderadm_off=<?php echo $idordergdg_off; ?>" formnovalidate  onclick="return confirm('Yakin Batal ?');"  style="position: absolute; right:45%;"  class="btn btn-danger">Batal</a></div>
</form>	
...
$("#check").submit(function(e) {
	...
	if(noseri == "" || ket_log == "") {
		...
		$.ajax({
			...
			data: "idseri="+idseri+"&noseri="+noseri+"&idorderfk="+idorderfk+"&ket_log="+ket_log+"&username="+username,
