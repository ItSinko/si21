...
<body>  
 ...
 <div class="row">
    <div class="col-sm">
      	 <a class="btn btn-primary"  id="tambah" href="?hlm=noserion&aksi=more&nolkppadm_on=<?php echo $nolkppgdg_on?>&aksiseri=tambah">Tambah Data</a> 
...
$a=1;
			...
			echo'			
                ...
                <tr>
                    <td width=1%">'. $a++ .'</td>
                    <td>'.$row['noseri_on'].'</td>				
					<td><a href="?hlm=noserion&aksi=more&nolkppadm_on='.$row["lkppfk_on"].'&aksiseri=edit&idseri_on='.$row["idseri_on"].'" class="cus-application_form_edit"></a>
					
					<a href="#" type="button" class="cus-cross" data-toggle="modal" data-target="#myModal'. $row["idseri_on"].'"></a> 
					</td>';
					?>
