...
<tr>
    ...
    <textarea class="form-control" rows="1" minlength="5" placeholder="Minimal isi 5 karakter..." id="ket_log" ></textarea>
	 ...
	 <a href="./index.php?hlm=noserispb&aksi=more&noadm_spb=<?php echo $nogdg_spb; ?>" formnovalidate  onclick="return confirm('Yakin Batal ?');"  style=	 "position: absolute; right:45%;"  class="btn btn-danger">Batal</a></div>
...
$("#check").submit(function(e) {
	...
	if(noseri == "" || ket_log == "") {
		...
		$.ajax({
			...
			data: "idseri="+idseri+"&noseri="+noseri+"&idserifk="+idserifk+"&ket_log="+ket_log+"&username="+username,
