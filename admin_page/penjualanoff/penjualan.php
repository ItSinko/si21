	...
	<hr class="my-2">
					...
					<div class="jplist-panel box panel-top">						
                        ...
                        <div 
						   ...
						   <button class="btn btn-primary"   onclick="location.href='./index.php?hlm=admoff&aksi=baru'">Tambah Data</button>
					</div>		
...
$result=mysqli_query($con,"SELECT * FROM admjual_off INNER JOIN spa_off ON spa_off.idorder_off = admjual_off.idorderadm_off
		...
		echo'                 
                            <tbody>                      
                                ...
                                ?>   	
								    <td><a href="?hlm=admoff&aksi=edit&idorderadm_off=<?=$row["idorderadm_off"]; ?>" class="cus-application_form_edit"></a> |
									<a href="#" type="button" class="cus-cross" data-toggle="modal" data-target="#myModal<?php echo $row["idorderadm_off"] ?>"></a>
									</td>			
								</tr>
