...
$mysqli= "UPDATE qc_off
          SET 
			tglterima_off = '$tglterima',
			tglserah_off = '$tglserah',
			ketqc_off = '$ket',
			pabrikqc_off = '$pabrik_on',
			idprodqc_off = '$idprod_on' WHERE idorderqc_off = '$idorderqc_off' ";
...
<button class="tips3" type="pesan2" onclick="location.href='qc.php'" ><span class="tooltips3" > ke halaman produk</span>Home</button>
