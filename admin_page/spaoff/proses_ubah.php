...
$tgl_edit_off = $_REQUEST["tgl_edit_off"];
...
//update ke database
$mysqli= "UPDATE spa_off SET no_off= '$no_off' , pemesan_off= '$pemesan_off', status_off = '$status_off',tgl_buat_off = '$tgl_buat_off',tgl_edit_off = '$tgl_edit_off', 
									  jumlah_off= '$jumlah_off',harga_off ='$hrg',ongkos_off= '$oks',diskon_nota_off = '$diskon_nota_off', diskon_uji_off = '$diskon_uji_off', temphari_off = '$temphari_off', ket_off = '$ket_off',idprod_off = '$idprod_off',
									   idrate2_off = '$idrate2_off',pabrik_off = '$pabrik_off' WHERE idorder_off = 'OFF-$idorder_off'";
		  


//update ke database ongkir 
...
if ($distributor=='SINKO PRIMA ALLOY PT')  { 
	...
	$ongkir= "UPDATE ongkirdb_off SET   nilai='$oks',idorderfk_off='OFF-$idorder_off' WHERE idongkir_off = '$idongkir'";
		  

	
	$result	= mysqli_query($con, $ongkir);
...
if(isset($_REQUEST["hitung"])) {
		echo "<script>
             alert('Error Salah Tombol !, Pencet Tambah'); 
             window.history.go(-1);
     </script>";
