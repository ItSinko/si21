...
?>
	...
	<hr class="my-2">
					...
					<div class="jplist-panel box panel-top">						
						...
						<div class="jplist-panel box panel-top">															
						<button class="btn btn-primary"   onclick="location.href='./index.php?hlm=admspb&aksi=baru'">Tambah Data</button>						
						</div>	
 ...
 <!-- data -->
                    ...
                    <div class="horizons">
						...
						//batas	
							...
							?>
							<td><a href="?hlm=admspb&aksi=edit&noadm_spb=<?=$row["noadm_spb"]; ?>" class="cus-application_form_edit"></a>		
						<a href="#" type="button" class="cus-cross" data-toggle="modal" data-target="#myModal<?=$row["noadm_spb"]; ?>"></a>
							</td>
							</tr>
