...
<tr>
 ...
 <legend class="legend_form">Pengiriman Barang</legend>
     ...
     <div class="col-sm-2">
      <input type="text" class="form-control" value="<?php echo $noeks_spb; ?>"  id="idorder" readonly  >
     </div>
     </div>
   ...
   <input type="text" class="form-control" min="1" max="1000" value="1"  id="dikirim"  >
	 ...
	 <a href="./index.php?hlm=eksspb&aksi=more&noeks_spb=<?php echo $noeks_spb; ?>" formnovalidate  onclick="return confirm('Yakin Batal ?');"  style="position: absolute; right:45%;"  class="btn btn-danger">Batal</a></div>
	 </div>
	 
	 <input type="text" id="jasafk_on"  >
    ...
    if(nama_eks == "" || tglreal == "" ||  dikirim == "" || nilai == "") {
		...
		$.ajax({
			type: "POST",
			url: "check_form/tambah/pengiriman_detail_spb.php",
			data: "idorder="+idorder+"&tglreal="+tglreal+"&dikirim="+dikirim+"&noresi="+noresi+"&ket="+ket+"&nilai="+nilai+"&jasafk_on="+jasafk_on,
