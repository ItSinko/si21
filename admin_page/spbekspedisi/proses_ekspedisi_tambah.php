...
$mysqli = "INSERT INTO ekspedisi2_spb
          VALUES
		  ('','$noeks_spb','$tglreal','$jumlah','$koli_spb','$noresi','$nilaiharga','$jasafk_spb','$keteks2_spb')";
		  
		 
$cek = mysqli_num_rows(mysqli_query($con,"SELECT * FROM ekspedisi2_spb WHERE noresi_spb='$noresi' "));	
