...
$id = $_REQUEST["id"];
$noeksfk_spb = $_REQUEST["noeksfk_spb"];

$tglreal = $_REQUEST["tglreal"];
$jumlah = $_REQUEST["jumlah"];
$jasafk_spb = $_REQUEST["jasafk_spb"];
$koli_spb = $_REQUEST["koli_spb"];
$keteks2_spb = $_REQUEST["keteks2_spb"];
...
//1.mengambil inputan dari tabel penjualan	
	$con= mysqli_connect("localhost","root","","kontrol_db");
			...
			$sql1 = mysqli_query($con, "SELECT jumlah_spb FROM spb 
							WHERE nospb ='$noeksfk_spb' ");
...
//2. menghitung jumlah barang yang sudah diinput 			
				$sql = mysqli_query($con, "SELECT COALESCE(SUM(jumlaheks_spb),0) as yo FROM ekspedisi2_spb 
				
							WHERE noeksfk_spb ='$noeksfk_spb' ");
...
$mysql2= "UPDATE ekspedisi2_spb SET 
			noeksfk_spb = '$noeksfk_spb',
		
			tglkirim_spb= '$tglreal',
			jumlaheks_spb = '$jumlah',
			koli_spb = '$koli_spb',
			noresi_spb = '$noresi',
			nilai_spb = '$nilaiharga',
				jasafk_spb = '$jasafk_spb',
					keteks2_spb = '$keteks2_spb'
			WHERE ideks_spb = '$id' ";
