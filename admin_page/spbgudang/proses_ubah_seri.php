...
if ($cek >0 ) {
		echo "<script>window.alert('Gagal ! No Seri Pernah Di Input')
		window.history.back()</script>";
}

else
{
$mysqli= "UPDATE seri_spb
          SET noseri_spb= '$noseri', nogdgfk='$nofk' WHERE idseri_spb= '$id'";
