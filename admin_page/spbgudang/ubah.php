...
<button type="submit" class="btn btn-success" style="position: absolute; right:55%;"  onclick="return confirm('Yakin Tambah Data ?');" id="tambah" name="tambah" >Ubah Data</button>	
...
$("#check").submit(function(e) {
	...
	if(nomorgudang_spb == "" || ket_log == "") {
		...
		$.ajax({
			...
			data: "nomorgudang_spb="+nomorgudang_spb+"&nosjgdg_spb="+nosjgdg_spb+"&tglsjgdg_spb="+tglsjgdg_spb+"&ketgdg_spb="+ketgdg_spb+"&idprodgdg_spb="+idprodgdg_spb+"&ket_log="+ket_log+"&username="+username,
