...
?>
	...
	<hr class="my-2">
					...
					<div class="jplist-panel box panel-top">						
					  ...
					  <div class="jplist-panel box panel-top">			
  <button class="btn btn-primary"   onclick="location.href='./index.php?hlm=piuoff&aksi=baru'">Tambah Data</button>						
						</div>	
 ...
 <!-- data -->
                    ...
                    <div class="horizon">
						...
						$result= mysqli_query($con,"SELECT * ,harga_off * jumlah_off as total
								...
								?>   	
								    <td><a href="?hlm=piuoff&aksi=edit&idorderuji_off=<?=$row["idorderuji_off"]; ?>" class="cus-application_form_edit"></a> |
									<a href="#" type="button" class="cus-cross" data-toggle="modal" data-target="#myModal<?=$row["idorderuji_off"]; ?>"></a>
									</td>			
								</tr>
