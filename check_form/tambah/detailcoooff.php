	...
	if(isset($_POST["noseri"]))  
        { 
            ...
            foreach ($_POST['noseri'] as $noseri) { 
                $query ="INSERT INTO detailcoo_off (nocoo_off, idordercoo_off,bulan_off,tglprintcoo_off,pabrikcoo_off,idprodcoo_off,idserifk_off,tglkirimcoo_off,tandaterima_off) VALUES ( '','$idorders','$date2','','$pabrikcoo_off','$idprodcoo_off',$noseri,'','')";
