...
$nocoo = $_REQUEST["nocoo"];
$nolkppcoo = $_REQUEST["nolkppcoo"];
$bulancoo = $_REQUEST["bulancoo"];
$nosericoo = $_REQUEST["nosericoo"];
$namacoo = $_REQUEST["namacoo"];
$pabrik_on = $_REQUEST["pabrik_on"];
$idprod_on = $_REQUEST["idprod_on"];
$pk_seri = $_REQUEST["pk_seri"];
...
if ($cek > 0) {
        ...
        echo "<script>window.alert(' Gagal !, No Seri Sudah Pernah Dimasukkan')
...
$mysqli = "INSERT INTO detailcoo_on 
          VALUES
		  ('$nocoo','$nolkppcoo','$bulancoo',
		  '$nosericoo','-','$pabrik_on','$idprod_on','$pk_seri')";
...
<button class="tips3" type="pesan2" onclick="location.href='detailcoo.php'" ><span class="tooltips3" > ke halaman produk</span>Home</button>
<script>
function goBack() {
    window.history.back();
}
