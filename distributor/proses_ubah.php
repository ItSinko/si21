...
//Query 2 Kondisi	
	//1.Kondisi Satu
	$update= "UPDATE distributor SET pabrik='$pabrik',  
								telp_dsb='$telp_dsb',  							
							alamat_dsb='$alamat_dsb', 
								   ket_dsb='$ket_dsb'
...
<button class="tips3" type="pesan2" onclick="location.href='distributor.php'" ><span class="tooltips3" > ke halaman akunting</span>Home</button>
