...
//prosesnya
$result2=mysqli_query($con,"SELECT * FROM  spa_on INNER JOIN distributor ON distributor.iddsb=spa_on.pabrik_on WHERE nolkpp_on='$nolkppxfk'");
...
$mysqli = "INSERT INTO ekspedisi2_on
          VALUES
		  ('','$nolkppxfk','$tglreal','$jumlah','$koli_on','$noresi','$nilaiharga','$jasafk_on','$keteks2_on')";
		  
		  
$ongkos = "INSERT INTO ongkirdb_on
          VALUES
		  ('','$nilaiharga','$nolkppxfk')";
		 
$cek = mysqli_num_rows(mysqli_query($con,"SELECT * FROM ekspedisi2_on WHERE noresi_on='$noresi' "));	
