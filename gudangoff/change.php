...
$("#check").submit(function(e) {
	...
	if(idorder == "" || nosj_off == "" || ket_log == "") {
		...
		$.ajax({
			...
			data: "idorder="+idorder+"&nosj_off="+nosj_off+"&tglsj_off="+tglsj_off+"&ketgdg_off="+ketgdg_off+"&pabrikgdg_off="+pabrikgdg_off+"&idprodgdg_off="+idprodgdg_off+"&ket_log="+ket_log,
