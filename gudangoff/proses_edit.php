...
$mysqli= "UPDATE gudang_off SET nosj_off= '$nosjgdg', tglsj_off='$tglsj', ketgdg_off='$ket',pabrikgdg_off='$pabrik_on',idprodgdg_off='$idprod_on' WHERE idordergdg_off = '$nolkppgdg'";
