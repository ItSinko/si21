...
$ket = $_REQUEST["ket"];
$namaprd = $_REQUEST["namaprd"];
$idprod_on = $_REQUEST["idprod_on"];
$pabrik_on = $_REQUEST["pabrik_on"];

//cek eror
$cek = mysqli_num_rows(mysqli_query($con,"SELECT * FROM gudang_off WHERE idordergdg_off='$idordergdg_off'"));
if ($cek > 0) {
...
$mysqli = "INSERT INTO gudang_off 
          VALUES
		  ('$idordergdg_off','$nosjgdg','$tglsj','$ket','$pabrik_on','$idprod_on')";
...
<button class="tips3" type="pesan2" onclick="location.href='gudang.php'" ><span class="tooltips3" > ke halaman gudang</span>Home</button>
<script>
function goBack() {
    window.history.back();
}
