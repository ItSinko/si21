...
<table class="table" >
<form method="post"  action="../check_form/export/lapjualoff.php">
 <fieldset >
...
<legend class="legend_form">Filter</legend>
  ...
  <div class="form-group row">
    ...
    $results = mysqli_query($con,"SELECT  pabrik,iddsb from spa_off  JOIN distributor ON spa_off.pabrik_off = distributor.iddsb GROUP BY iddsb");        
