...
<a target="_blank" href="export_excel.php"><i class="cus-arrow_down"></i>Export</a>
   ...
   <label class="status-fltr">Status:</label>  
	...
	<select  id="status-filter" title="Filter Data Berdasarkan Status Paket">
	    ...
	    <label class="nmprd-fltr">Nama Produk :</label>  
                ...
                $query = mysqli_query($con,"SELECT nam_prod
		      ...
		      <label class="aks-fltr">Pemesan :</label>  
                ...
                $query = mysqli_query($con,"SELECT pemesan_off
												FROM spa_off INNER JOIN  admjual_off ON spa_off.idorder_off=admjual_off.idorderadm_off
												INNER JOIN qc_off ON admjual_off.idorderadm_off = qc_off.idorderqc_off
												INNER JOIN  gudang_off ON qc_off.idorderqc_off = gudang_off.idordergdg_off
												INNER JOIN  produk_master ON produk_master.id_prod = spa_off.idprod_off
                ...
                $query = mysqli_query($con,"SELECT pabrik
												FROM spa_off INNER JOIN  admjual_off ON spa_off.idorder_off=admjual_off.idorderadm_off
												INNER JOIN qc_off ON admjual_off.idorderadm_off = qc_off.idorderqc_off
												INNER JOIN  gudang_off ON qc_off.idorderqc_off = gudang_off.idordergdg_off
												INNER JOIN  produk_master ON produk_master.id_prod = spa_off.idprod_off
			  ...
			  <datalist id="daftar-nopo">
                ...
                $query = mysqli_query($con,"SELECT nopo_off
												FROM spa_off INNER JOIN  admjual_off ON spa_off.idorder_off=admjual_off.idorderadm_off
												INNER JOIN qc_off ON admjual_off.idorderadm_off = qc_off.idorderqc_off
												INNER JOIN  gudang_off ON qc_off.idorderqc_off = gudang_off.idordergdg_off
												INNER JOIN  produk_master ON produk_master.id_prod = spa_off.idprod_off
                ...
                while ($row = mysqli_fetch_array($query)) {
                ?>			
                    <option value="<?php echo $row['nopo_off']; ?>"></option>
                <?php
                }
                ?>
              </datalist>
			  ...
			  <datalist id="daftar-noseri">
                ...
                $query = mysqli_query($con,"SELECT noseri_off
												FROM spa_off INNER JOIN  admjual_off ON spa_off.idorder_off=admjual_off.idorderadm_off
												INNER JOIN qc_off ON admjual_off.idorderadm_off = qc_off.idorderqc_off
												INNER JOIN  gudang_off ON qc_off.idorderqc_off = gudang_off.idordergdg_off
												INNER JOIN  produk_master ON produk_master.id_prod = spa_off.idprod_off
                ...
                while ($row = mysqli_fetch_array($query)) {
                ?>			
                    <option value="<?php echo $row['noseri_off']; ?>"></option>
                <?php
                }
                ?>
              </datalist>
...
switch ($angka) {
	...
	default:
		...
		echo'
			...
			<td class=kanan>'. number_format($row["ongkos_off"]).'</td>
