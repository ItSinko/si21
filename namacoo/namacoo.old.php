...
<tr>
	...
	<th width="11%">Type Produk</th>
	<th width="18%">Nama Produk</th>
	<th>Merk</th>
	<th width="11%">Kategori Produk</th>
	<th width="18%">Nama Coo</th>
	...
	<th>Tombol</th>
			...
			$query=mysqli_query($con,"SELECT * FROM produk_master ORDER BY sing_prod ASC");	
...
switch ($angka) {
	...
	default:
		...
		?>
<td>
<a href="edit.php?id_prod=<?= $row["id_prod"]; ?>" class="cus-application_form_edit"></a> | 
<a href="hapus.php?id_prod=<?= $row["id_prod"]; ?>
