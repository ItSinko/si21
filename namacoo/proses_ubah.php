...
echo '<div id="tampil_modal">
	...
	<script>
	   ...
	   document.location.href= 'namacoo.php';
	 </script>
	 ";
...
<button class="tips3" type="pesan2" onclick="location.href='namacoo.php'" ><span class="tooltips3" > ke halaman produk</span>Home</button>
<script>
function goBack() {
    window.history.back();
}
