...
<legend class="legend_form">Nomer Seri</legend>
    ...
    <input class="form-control " type="text" placeholder="99" id="idseri"  name="idorderoff" value= "<?php echo $idordergdg_off; ?>" readonly> 
 ...
 $(document).ready(function(){  
   $('#noseri').blur(function(){
     ...
     $.ajax({
	  ...
	  url:'check_double/tambah/noserioff.php',
      method:"POST",
      data:{noseri:noseri},
...
$("#check").submit(function(e) {
	...
	if(noseri == "") {
		...
		$.ajax({
			type: "POST",
			url: "check_form/tambah/noserioff.php",
