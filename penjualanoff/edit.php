...
$("#check").submit(function(e) {
	...
	if(nopo_off == "" || tglpo_off == ""|| ket_log == "") {
		...
		$.ajax({
			...
			data: "idorder="+idorder+"&nopo_off="+nopo_off+"&tglpo_off="+tglpo_off+"&nodo_off="+nodo_off+"&tgldo_off="+tgldo_off+"&ketadm_off="+ketadm_off+"&idprod_off="+idprod_off+"&pabrik_off="+pabrik_off+"&ket_log="+ket_log,
