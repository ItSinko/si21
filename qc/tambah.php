...
<div class="col-sm-1 ">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-3 ">
      <select  class="form-control " style=" height:32px;" onchange="changeValue(this.value)" id="nolkpp" >
    ...
    while ($row = mysqli_fetch_array($result)) {    
        ...
        $jsArray .= "dtMhs['" . $row['nolkppadm_on'] . "'] = {
														...
														satuan:'" .addslashes($row['satuan_prod'])."',	
															};\n";
	}   
    ?>
      </select>
    ...
    <input class="form-control jumlah"  type="text"  style="height:28px; width:70px;" onkeyup="rp();count();"  id="jumlah"placeholder="99" readonly>
     ...
     <div class="col-sm-6">
     <input type="date" class="form-control harga"  id="tglterima" placeholder="XXXX/XX/XXXX/2019"   >
     </div>
	 </div>
     </fieldset>
     ...
     <div class="col-sm-6">
     <input type="date" class="form-control harga"  id="tglserah" placeholder="XXXX/XX/XXXX/2019"   >
     </div>
	 </div>
	 </fieldset> 
	 ...
	 <input type="hidden" id="idpabrik_on" >
	...
	document.getElementById('satuan_prod').value = dtMhs[nolkpp].satuan;	
...
$("#check").submit(function(e) {
	...
	if(nopo== "" ||tglserah == "" ||tglterima == "") {
		$("#error_message").show().html("Harap Mengisi, Field yang wajib di isi! (*)");
		} else {
		$("#error_message").html("").hide();
		$.ajax({
			type: "POST",
			url: "check_form/tambah/qc.php",
			data: "nolkpp="+nolkpp+"&tglserah="+tglserah+"&tglterima="+tglterima+"&idprod_on="+idprod_on+"&idpabrik_on="+idpabrik_on+"&ket="+ket,
