...
$("#form-contact").submit(function(e) {
	...
	{	
		...
		$.ajax({
			...
			data: "nolkpp="+nolkpp+"&jumlah="+jumlah+"&harga="+harga+"&satuan="+satuan+"&tgledit="+tgledit+"&noaks="+noaks+"&ongkir="+ongkir+"&deskripsi="+deskripsi+"&instansi="+instansi+"&status="+status+"&tglbuat="+tglbuat+"&ket="+ket+"&diskonspa="+diskonspa+"&diskonujispa="+diskonujispa+"&pabrik_on="+pabrik_on+"&idprod_on="+idprod_on+"&expdates="+expdates+"&no="+no+"&ket_log="+ket_log,
