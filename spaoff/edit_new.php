...
$("#form-contact").submit(function(e) {
	...
	if(idorderoff == "" || jumlah == "" || pemesan == "" || ongkir == ""|| distributor == ""|| status == ""|| type == "" || ket_log == "") {
		...
		$.ajax({
			...
			data: "distributor="+distributor+"&idorderoff="+idorderoff+"&status="+status+"&tglbuat="+tglbuat+"&tgledit="+tgledit+"&ket="+ket+"&harga="+harga+"&jumlah="+jumlah+"&ongkir="+ongkir+"&total="+total+"&nmprd="+nmprd+"&type="+type+"&diskonspa="+diskonspa+"&diskonujispa="+diskonujispa+"&expdates="+expdates+"&idprod_on="+idprod_on+"&pabrik_on="+pabrik_on+"&idrate2_on="+idrate2_on+"&pemesan="+pemesan+"&no_off="+no_off+"&ket_log="+ket_log,
