...
$("#check").submit(function(e) {
	...
	if(nomorspb == "" || pelanggan_spb == "" || untuk_spb == "" || ket_log == "") {
		...
		$.ajax({
			...
			data: "nomorspb="+nomorspb+"&pelanggan_spb="+pelanggan_spb+"&untuk_spb="+untuk_spb+"&jumlah_spb="+jumlah_spb+"&harga="+harga+"&harga_spb="+harga_spb+"&ket_spb="+ket_spb+"&idproduk_spb="+idproduk_spb+"&ket_log="+ket_log,
