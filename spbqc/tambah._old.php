...
<legend class="legend_form">Info Produk</legend>
    ...
    <div class="col-sm-4 ">
    <select id="nomorqc_spb" class="selectpicker" onchange="changeValue(this.value)">
	<option value="" >-Pilih ID-</option>
    <?php 
	$con=mysqli_connect("localhost","root","","kontrol_db");
    $result = mysqli_query($con,"SELECT * FROM spb INNER JOIN produk_master ON spb.idprod_spb = produk_master.id_prod 
												   INNER JOIN admjual_spb ON spb.nospb = admjual_spb.noadm_spb
	...
	<input type="hidden" class="form-control" id="idprodqc_spb" placeholder="Nama Distributor" readonly>
