...
$("#check").submit(function(e) {
	...
	if(nomorqc_spb == "" || ket_log == "") {
		...
		$.ajax({
			...
			data: "nomorqc_spb="+nomorqc_spb+"&tglterimaqc_spb="+tglterimaqc_spb+"&tglserahqc_spb="+tglserahqc_spb+"&ketqc_spb="+ketqc_spb+"&idprodqc_spb="+idprodqc_spb+"&ket_log="+ket_log,
