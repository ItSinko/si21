  ...
  <script src="jquery-1.10.2.min.js"></script>
	...
	if(nolkpp== "" || invuji== "" || kasuji== "" || ket_log== "") {
		...
		$.ajax({
			...
			data: "nolkpp="+nolkpp+"&invuji="+invuji+"&tgluji="+tgluji+"&tarifuji="+tarifuji+"&tglbayar="+tglbayar+"&kasuji="+kasuji+"&ketuji="+ketuji+"&iddsb="+iddsb+"&id_prod="+id_prod+"&ket_log="+ket_log,
