...
$("#check").submit(function(e) {
	...
	if(idorder == "" || invuji_off == "" || tgluji_off == "" || kasuji_off == "" || ket_log == "") {
		...
		$.ajax({
			...
			data: "idorder="+idorder+"&invuji_off="+invuji_off+"&tgluji_off="+tgluji_off+"&tarifuji_off="+tarifuji_off+"&tglbayaruji_off="+tglbayaruji_off+"&kasuji_off="+kasuji_off+"&ketuji_off="+ketuji_off+"&idprodukuji_off="+idprodukuji_off+"&distributoruji_off="+distributoruji_off+"&ket_log="+ket_log,
